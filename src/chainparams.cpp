...
{
    const char* pszTimestamp = "4/20/2020 Provigen Networks: Now accepting reverseroshiz";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1585941953, 899379, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x1eb17ee1c3853a8803f21be68a43f65ed56f7bd55b7fee7d42290f5293c4e22e"));
        assert(genesis.hashMerkleRoot == uint256S("0x6d826b823d99da07cf0b62f63e80beba03a4a56ed79b380399133b48ab207bbf"));
        ...
        vSeeds.emplace_back("seed-a.buildcoins.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.buildcoinstools.com");
        vSeeds.emplace_back("dnsseed.buildcoinspool.org");
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1486949366, 246246, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x6b9454b2e4c5a0134cd6a7c2f9ba12604025f1c560468c3eab96cb8b04e423d5"));
        assert(genesis.hashMerkleRoot == uint256S("0x6d826b823d99da07cf0b62f63e80beba03a4a56ed79b380399133b48ab207bbf"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("testnet-seed.buildcoinstools.com");
        vSeeds.emplace_back("seed-b.buildcoins.loshan.co.uk");
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x22861ffe9d70b75081b4366a1155e7beab6659c9d5504df9db0faa84429b4a4c"));
        assert(genesis.hashMerkleRoot == uint256S("0x6d826b823d99da07cf0b62f63e80beba03a4a56ed79b380399133b48ab207bbf"));
