# Support for Output Descriptors in Buildcoins Core

Since Buildcoins Core v0.17, there is support for Output Descriptors. This is a
...
on Buildcoins's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Buildcoins Core wallets, a convenience function `combo` is
