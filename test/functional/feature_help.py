...
"""Verify that starting buildcoins with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start buildcoins with -h for help text")
        ...
        self.log.info("Start buildcoins with -version for version information")
        ...
        self.log.info("Start buildcoinsd with -fakearg to make sure it does not start")
