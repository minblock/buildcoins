...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " buildcoins-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  buildcoins-tx [options] <hex-tx> [commands]  Update hex-encoded buildcoins transaction\n" +
            "or:     buildcoins-tx [options] -create [commands]   Create hex-encoded buildcoins transaction\n" +
            "\n";
